...
def setupSimulation(coil_current, magnet_height):
    # field
    ...
    permeability = 1.11 # permeability of the permanent magnet
    flux_density = 1.28 # flux density of the permanent magnet
    ...
    sim.add_material("magnet", {"magnetic_permeability": permeability, "magnetic_remanence": flux_density, "magnetic_remanence_angle": 90})
    ...
    geometry = setupGeometry(magnet_height)

    return sim

def setupGeometry(magnet_height):
    ...
    geometry.add_edge(x_core_inner, magnet_height, x_core_outer, magnet_height, angle = 0)
    geometry.add_edge(x_core_outer, magnet_height, x_core_outer, y_u_core_outer, angle = 0)
    ...
    geometry.add_edge(x_core_inner, y_u_core_inner, x_core_inner, magnet_height, angle = 0)

    # magnet
    geometry.add_edge(x_core_inner, 0, x_core_outer, 0, angle = 0)
    geometry.add_edge(x_core_outer, 0, x_core_outer, magnet_height, angle = 0)
    geometry.add_edge(x_core_inner, 0, x_core_inner, magnet_height, angle = 0)
    ...
    geometry.add_label(x_core_inner  + (x_core_outer - x_core_inner) / 2, magnet_height / 2, materials={"magnetic": "magnet"})  # magnet
